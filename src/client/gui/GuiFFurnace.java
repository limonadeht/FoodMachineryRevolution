...
public class GuiFFurnace extends GuiContainer{

	public static final ResourceLocation bground = new ResourceLocation("fmr", "textures/gui/ffurnace.png");

	public TileEntityFFurnace tileentity;

	public GuiFFurnace(InventoryPlayer invplayer, TileEntityFFurnace entity){
		super(new ContainerFFurnace(invplayer, entity));
