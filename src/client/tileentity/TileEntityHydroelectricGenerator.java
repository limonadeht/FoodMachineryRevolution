...
public class TileEntityHydroelectricGenerator extends TileEntityBase implements IEnergyHandler{

	private EnergyStorage energyStorage;
	private int energyGeneration;

	public TileEntityHydroelectricGenerator(int energyGeneration, int energyTransfer, int energyCapacity){
	...
	public void transferEnergy(){
	    for (ForgeDirection direction : ForgeDirection.VALID_DIRECTIONS)
	    {
	      ...
	      if (!(tileEntity instanceof TileEntityHydroelectricGenerator)) {
	...
	public static class Advanced extends TileEntityHydroelectricGenerator{
