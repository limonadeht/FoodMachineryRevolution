...
import recipe.FCraftTableCraftingManager;

public class ContainerFCraftingTable extends Container{
	...
	public ContainerFCraftingTable(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iiventory) {
		craftResult.setInventorySlotContents(0, FCraftTableCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}


	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != MaterialRegister.foodCraftTable){
			return false;
		}else{
