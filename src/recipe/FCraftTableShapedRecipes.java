...
public class FCraftTableShapedRecipes implements IRecipe{
	...
	public FCraftTableShapedRecipes(int par1, int par2, ItemStack[] ArrayOfItemStack, ItemStack itemstack){
    ...
    public FCraftTableShapedRecipes func_92100_c()
    {
